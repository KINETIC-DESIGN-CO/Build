...
class ProblemIntakePolicyTests(unittest.TestCase):
    ...
    def test_response_contract_discloses_persistence_and_current_job(self):
        ...
        self.assertEqual(
            ...
            "NEXT_STEP_STATES_THE_EXACT_WORK_THIS_THREAD_OWNS_AND_WILL_EXECUTE;WHEN_THREAD_LIFECYCLE_BOUNDARY_IS_TERMINAL_HANDOFF_RENDER_TERMINAL_HANDOFF_OPTIONS_AND_DO_NOT_EXECUTE_AN_UNRELATED_CANDIDATE_WITHOUT_EXACT_CONTINUE_EVIDENCE",
        )
