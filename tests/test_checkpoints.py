...
class CheckpointTests(unittest.TestCase):
    ...
    def test_bootstrap_requires_checkpoint_and_provenance_surfaces(self):
        ...
        self.assertIn("python scripts/validate_checkpoints.py", bootstrap["validation_command"])
    ...
    def test_policy_has_only_exact_checkpoint_triggers(self):
        ...
        self.assertIn("MODEL_JUDGMENT_AS_TRIGGER", json.loads((ROOT / "continuity/checkpoint-template.json").read_text())["prohibited_interpretations"])
